  ...
  return (
        ...
        <div className='navbar'>
            <div className='navbar__logo'>
                <h2  onClick={()=> {setActive("Home"); navigate("/")}} >IF News</h2>
            </div>
            ...
            <div className="navbar__search">
                <input className='search-input' type="text" placeholder="Search" onChange={(e)=> setSearch(e.target.value)} value={search} onKeyDown={(e) => e.key === 'Enter' && handleSearch()} />
